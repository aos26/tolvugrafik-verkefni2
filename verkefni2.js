...
function render() {
    ...
    rotDay += 3.0;
    rotYear += 0.9;        // not the correct value, but looks better!
    rotYearP -= 1.1;
    rotYearS += 0.5;
    ...
    */
    ...
    // teikna s-type pláneta
    mvstack.push(mv);
    mv = mult(mv, rotateY(rotYearS));
    mv = mult(mv, translate(0.3, 0.0, 0.0));
    //mv = mult( mv, rotateY( rotDay ) );
    ...
    mvstack.push(mv);
    //teikna p-type pláneta
    mv = mult(mv, rotateY(rotYearP));
